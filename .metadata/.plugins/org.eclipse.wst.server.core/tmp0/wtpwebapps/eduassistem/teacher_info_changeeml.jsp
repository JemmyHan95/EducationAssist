...
<body>
<script type="text/javascript" src="js/temlcheck.js"></script>
<table width="740" border="0">
<tr>
<td colspan="2" style="background-color:#99bbbb;">
<h1>欢迎回来!<%out.print(session.getAttribute("name"));%>老师</h1><a href="index.jsp">退出</a>
</td>
</tr>
<tr valign="top">
...
<input type="hidden" name="exetype" value="cem" />
<table>
<tr><td>请输入新联系方式:</td></tr>
<tr><td><input type="text" name="neweml" /></td></tr>
