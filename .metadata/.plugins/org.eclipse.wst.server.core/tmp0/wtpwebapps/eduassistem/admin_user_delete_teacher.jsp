...
<input type="hidden" name="exetype" value="delte" />
<table>
<th>删除教师</th>
<tr>
<td>教师编号</td><td>教师姓名</td><td>教师性别</td><td>所属学院</td><td>联系方式</td>
</tr>
<%
String qsql="select * from teacher";
...
<td><%out.print(qrs.getString("email"));%></td>
