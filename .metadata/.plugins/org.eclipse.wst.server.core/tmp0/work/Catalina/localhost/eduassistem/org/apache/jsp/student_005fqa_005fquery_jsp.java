 ...
 * Generated at: 2016-04-28 01:07:42 UTC
...
public final class student_005fqa_005fquery_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(!rs.isBeforeFirst()) {
	que.dbClose();
      ...
      out.write("<tr><td>");
out.print("您尚未有过问答记录!");
      out.write("</td></tr><tr><td><a href=\"student_qa.jsp\">返回</a></td></tr>");

}
else {
	
      out.write("<tr><td>提问</td><td>教师</td><td>答复</td><td>时间</td>");
...
out.print(rs.getString("ask"));
      out.write("</td>\r\n");
      out.write("\t\t<td>");
trs.next();out.print(trs.getString("name"));
      out.write("</td>\r\n");
      out.write("\t\t<td>");
String answer=rs.getString("answer");if(answer.equals(""))out.print("尚未回复");else out.print(answer);
      out.write("</td>\r\n");
      out.write("\t\t<td>");
