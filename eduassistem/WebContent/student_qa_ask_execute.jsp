...
String sql="insert into communication (sID,tID,ask,answer,time) values ('"+session.getAttribute("onuser")+"','"+request.getParameter("teacher")+"','"+ask+"','','"+request.getParameter("time")+"')";
if(exe.dbUpdate(sql)) {
	exe.dbClose();
