...
<table>
<tr><td colspan="4">请选择需添加的用户类型:</td></tr>
<tr>
<form action="admin_user_add.jsp" method="post">
<table>
<tr>
<td>
<select name="type">
...
if(type!=null&&type.equals("teacher"))
	response.sendRedirect("admin_user_add_teacher.jsp");
if(type!=null&&type.equals("student"))
	response.sendRedirect("admin_user_add_student.jsp");
%>
</body>
</html>